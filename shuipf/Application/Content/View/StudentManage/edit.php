...
<body class="J_scroll_fixed">
    ...
    <div class="wrap J_check_wrap">
        ...
        <form class="J_ajaxForms" name="myform" id="myform" action="{:U('StudentManage/edit',array(id=>$id,isUpdate=>1))}" method="get">
            ...
            <div>
                ...
                <div class="table_full">
                                ...
                                <table width="100%" class="table_form ">
                                    <volist name="studentmanage" id="edit">
                                    <tr id="normal_id">
                                        <th>证件号：</th>
                                        <td><input type="text" name="info[catID]" id="catID" class="input" value="{$edit.paperId}"></td>
                                    </tr>
                                    <tr id="normal_add">
                                        <th>学员姓名：</th>
                                    ...
                                    <tr id="catdir_tr">
                                        ...
                                        <th>手机号：</th>
                                        <td><input type="text" name="info[catdir]" id="catdir" class="input" value="{$edit.phone}"></td>
                                                ...
                                                button:[
                                                    {
                                                        ...
                                                        name: '返回栏目管理页',
                                                        callback:function(){
                                                            window.location.href = "{:U('StudentManage/index')}";
                                                            return true;
                                                        }
                                                    }
                                                ]
