...
<body class="J_scroll_fixed">
    ...
    <div class="wrap J_check_wrap">
        ...
        <form class="J_ajaxForms" name="myform" id="myform" action="{:U('CompanyMsg/edit',array(id=>$id,isUpdate=>1))}" method="get">
        <div class="J_tabs_contents">
            <div>
                ...
                <div class="table_full">
                    <div id="type">
                                <select id="mySelect">
                                    <option value="hz">提交信息</option>
                                    <option value="picture">上传图片</option>
                                </select>
                                <div id="type_picture" style="display:none">
                                    ...
                                    <tr>
                                        <td>
                                            <div style="text-align: center;">
                                                ...
                                                <a href="javascript:void(0);" onclick="flashupload('thumb_images', '附件上传','thumb_preview|catdir',getSrc,'1,jpg|jpeg|gif|png|bmp,1,,,0','Content','3','86b6b41fe5fca57b6f29edcc2430ccf3');return false;">
      <img src="/statics/images/icon/upload-pic.png" id="thumb_preview" width="135" height="113" style="cursor:hand"></a>             
                                ...
                                <table width="100%" class="table_form ">
                                <tbody>
                                <volist name="companymsg" id="edit">
                                    <tr id="normal_add">
                                        <th>属性名：</th>
                                    ...
                                    <tr id="catdir_tr">
                                        ...
                                        <th>属性值：</th>
                                        <td><input type="text" name="info[catdir]" id="catdir" class="input" value="{$edit.value}"></td>
...
function getSrc(uploadid, returnid)
{
  //取得iframe对象
    ...
    arrID=returnid.split('|');
    $("#"+arrID[0]).attr("src",in_content);
    $("#"+arrID[1]).val(in_content);
}
        ...
        $("#mySelect").ready(function () {
            $('#mySelect').change(function () {
                if($('#mySelect').val()=="hz")
                {
                  ...
                  $("#type_picture").css("display","none");
                  $("#catdir_tr").css("display","table-row");
                 
                }
                if($('#mySelect').val()=="picture")
                {
                  $("#catdir_tr").css("display","none");
                    $("#type_picture").css("display","block");
                }
            });
        });
                                                ...
                                                button:[
                                                    {
                                                        ...
                                                        name: '返回栏目管理页',
                                                        callback:function(){
                                                            window.location.href = "{:U('CompanyMsg/index')}";
                                                            return true;
                                                        }
                                                    }
                                                ]
