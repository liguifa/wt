...
.header h1{ background-image:url({$config_siteurl}statics/images/logo.gif);background-repeat:no-repeat;width:427px;height:98px;line-height:150px;overflow:hidden;font-size:0}
...
<div class="footer">
  <div class="inner">
    <div class="copyright clearfix">
      <p class="copyright_en">Copyright &copy; 2012 - {:date('Y')} , 大连万通驾校 版权所有.</p>
