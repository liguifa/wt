...
<style type="text/css">
 html{font-size:62.5%;font-family:Tahoma;overflow: hidden;}
...
.header h1{ background-image:url(<?php echo ($config_siteurl); ?>statics/images/logo.gif);background-repeat:no-repeat;width:427px;height:98px;line-height:150px;overflow:hidden;font-size:0}
.qzone_login{margin-top:20px}
...
<div class="footer">
  <div class="inner">
    <div class="copyright clearfix">
      <p class="copyright_en">Copyright &copy; 2012 - <?php echo date('Y');?> , 大连万通驾校 版权所有.</p>
      <p class="copyright_ch"><a href="http://www.shuipfcms.com" target="_blank">http://www.liguifa.wang</a></p>
    </div>
  </div>
</div>
