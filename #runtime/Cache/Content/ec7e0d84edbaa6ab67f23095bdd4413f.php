...
<?php } ?>
        ...
        <form class="J_ajaxForms" name="myform" id="myform" action="<?php echo U('FieldsManage/edit',array(id=>$id,isUpdate=>1));?>" method="get">
            ...
            <div>
                ...
                <div class="table_full">
                                ...
                                <table width="100%" class="table_form ">
                                    <?php if(is_array($Fields)): $i = 0; $__LIST__ = $Fields;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$edit): $mod = ($i % 2 );++$i;?><tr id="normal_id">
                                        <th>身份证号：</th>
                                        <td><input type="text" name="info[catID]" id="catID" class="input" value="<?php echo ($edit["userId"]); ?>"></td>
                                    </tr>
                                    <tr id="normal_add">
                                        <th>用户名：</th>
                                    ...
                                    <tr id="catdir_tr">
                                        ...
                                        <th>考试进度：</th>
                                        <td><input type="text" name="info[catdir]" id="catdir" class="input" value="<?php echo ($edit["processe"]); ?>"></td>
                                                ...
                                                button:[
                                                    {
                                                        ...
                                                        name: '返回栏目管理页',
                                                        callback:function(){
                                                            window.location.href = "<?php echo U('FieldsManage/index');?>";
                                                            return true;
                                                        }
                                                    }
                                                ]
