...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="10">
  ...
  <td>
    ...
    <?php if(is_array($types)): $i = 0; $__LIST__ = $types;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?><option value="<?php echo ($type["catid"]); ?>"><?php echo ($type["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
    </select>
  </td>
  </tr>
  <tr>
  ...
  <td>
    ...
    <?php if(is_array($papers)): $i = 0; $__LIST__ = $papers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?><option value="<?php echo ($p); ?>"><?php echo ($p); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
    </select>
  </td>
  </tr>
  <tr>
