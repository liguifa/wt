...
<?php } ?>
        ...
        <form class="J_ajaxForms" name="myform" id="myform" action="<?php echo U("StudentManage/add");?>" method="post">
            ...
            <div>
                ...
                <div class="table_full">
                                ...
                                <tbody>
                                    <tr id="normal_add">
                                        <th>证件号：</th>
                                        <td><input type="text" name="info[catID]" id="catID" class="input" value=""></td>
                                    </tr>
                                    <tr id="normal_add">
                                        <th>用户名：</th>
