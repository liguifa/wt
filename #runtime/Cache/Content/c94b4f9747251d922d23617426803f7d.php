...
<?php } ?>
        ...
        <form class="J_ajaxForms" name="myform" id="myform" action="<?php echo U('StudentManage/edit',array(id=>$id,isUpdate=>1));?>" method="get">
            ...
            <div>
                ...
                <div class="table_full">
                                ...
                                <table width="100%" class="table_form ">
                                    <?php if(is_array($studentmanage)): $i = 0; $__LIST__ = $studentmanage;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$edit): $mod = ($i % 2 );++$i;?><tr id="normal_id">
                                        <th>证件号：</th>
                                        <td><input type="text" name="info[catID]" id="catID" class="input" value="<?php echo ($edit["paperId"]); ?>"></td>
                                    </tr>
                                    <tr id="normal_add">
                                        <th>学员姓名：</th>
                                        <td><input type="text" name="info[catname]" id="catname" class="input" value="<?php echo ($edit["name"]); ?>"></td>
                                    </tr>
                                    <tr id="catdir_tr">
                                    
                                        <th>手机号：</th>
                                        <td><input type="text" name="info[catdir]" id="catdir" class="input" value="<?php echo ($edit["phone"]); ?>"></td>
                                                ...
                                                button:[
                                                    {
                                                        ...
                                                        name: '返回栏目管理页',
                                                        callback:function(){
                                                            window.location.href = "<?php echo U('StudentManage/index');?>";
                                                            return true;
                                                        }
                                                    }
                                                ]
