...
<?php } ?>
  ...
  <form name="myform" class="J_ajaxForm" action="<?php echo U("Field/add");?>" method="post">
  ...
  <table width="100%" class="table_form contentWrap">
      <tr>
        ...
        <td><select name="formtype" id="formtype" onChange="javascript:field_setting(this.value);">
            ...
            <?php if(is_array($all_field)): $i = 0; $__LIST__ = $all_field;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" ><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
          </select></td>
      </tr>
      <tr>
